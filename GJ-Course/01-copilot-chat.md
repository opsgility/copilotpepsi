---
lab:
  title: 'Exercise 1: Copilot Chat — Research, Brainstorm & Summarize'
  description: 'Use Microsoft 365 Copilot Chat in both Web and Work modes to research topics, brainstorm ideas, and summarize organizational content.'
  duration: 30 minutes
  level: 100
  islab: true
  primarytopics:
...
# Exercise 1: Copilot Chat — Research, Brainstorm & Summarize (30 min)
---

Copilot Chat is your AI assistant available across Microsoft 365. It operates in two modes:

- **Web mode** — Grounded in internet data. Use it for market research, industry trends, and general knowledge.
- **Work mode** — Grounded in your organizational data (emails, files, meetings, chats). Use it to summarize internal documents, find information across your Microsoft 365 content, and answer questions about your work.

In this exercise, you'll use both modes to complete tasks relevant to G&J Pepsi.

---

### Task 1: Research and brainstorm with Web mode (10 min)
...
### Task 2: Summarize organizational content with Work mode (10 min)

Switch to Work mode to query your internal documents.

1. In Copilot Chat, switch to the **Work** toggle.
...
### Task 3: Cross-departmental research (10 min)

Practice using Copilot Chat for tasks relevant to your specific department. Choose the scenario closest to your role, or try one that's new to you.

**For Accounting / Finance:**
> "What are the latest FASB updates that would affect a beverage distribution company's revenue recognition? Summarize the key changes and what our accounting team should do to prepare."

**For HR / Learning & Development:**
> "Draft an outline for a 2-hour training session on effective communication skills for warehouse supervisors. Include interactive activities and discussion prompts."

**For IT:**
> "Summarize the pros and cons of migrating our on-premises ERP system to a cloud-based solution. Consider cost, security, downtime, and integration with our current warehouse management system."

**For Field Sales / Retail:**
> "What are the most effective retail merchandising strategies for beverage products in convenience stores? Give me 5 tactics with examples from the industry."

**For Operations / Supply Chain:**
> "Analyze the current challenges in cold chain logistics for beverage distribution. What technologies are being used to reduce spoilage and improve route efficiency?"
