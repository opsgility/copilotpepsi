---
lab:
  title: 'Exercise 4: Outlook — Draft, Summarize & Coach'
  description: 'Use Copilot in Outlook to draft emails from prompts, summarize long email threads, and get coaching on tone and clarity.'
  duration: 45 minutes
  level: 100
  islab: true
  primarytopics:
...
# Exercise 4: Outlook — Draft, Summarize & Coach (45 min)
---

Copilot in Outlook helps you draft emails faster, catch up on long threads, and improve your writing. The three key capabilities:

- **Draft** — Describe what you want to say, and Copilot generates a full email. Iterate through numbered drafts and select **"Keep it"** when satisfied.
- **Summarize** — Condense a lengthy email thread into key points and action items.
- **Coaching** — Get feedback on tone, clarity, and sentiment before you send.

**How to access:** In a new email, select the **Open Copilot** (pencil) icon in the message body. For summarizing, select Copilot at the top of an email thread.

---

### Task 1: Draft emails for different audiences (15 min)
...
### Task 2: Summarize email threads (10 min)

For this task, you'll practice the summarize capability. Since we're working in a training environment, you can practice with any existing email thread in your inbox, or use the following approach:
...
### Task 3: Use Coaching to improve your emails (10 min)

Copilot's coaching feature reviews your draft email and provides suggestions on tone, clarity, and reader sentiment.

1. Create a new email in **Outlook on the web**. Type a draft manually (don't use Copilot to generate it). Write a quick 3-4 sentence email about any work topic — it doesn't need to be perfect. In fact, it's better if it's a rough first attempt.
...
### Task 4: Department-specific email practice (10 min)

Write your own prompt for an email relevant to your actual role. Here are starters:

**Accounting:** "Draft an email to department managers requesting Q1 budget variance explanations by end of week. Include a template for their response."

**HR / L&D:** "Draft an invitation for a mandatory compliance training session. Include logistics, what to prepare, and a note about accommodations."

**IT:** "Draft a change notification email about scheduled system maintenance this weekend. Include impact, downtime window, and escalation contacts."

**Sales:** "Draft a congratulations email to the sales team for hitting Q4 targets. Highlight top performers and tease next quarter's incentive program."

**Operations:** "Draft an email to warehouse supervisors about a new safety protocol taking effect next month. Include a brief summary and link to the full documentation."

**Supply Chain:** "Draft an email to vendors announcing a shift in our ordering cadence from weekly to bi-weekly. Explain the business rationale and address likely concerns."
